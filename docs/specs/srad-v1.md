# SRAD Autonomy Framework (v1 — superseded)

> **Superseded.** This is the original SRAD scheme: a grade-count / Resolution-Average
> confidence score, hand-written four-level grades, and `Unresolved` / `R<25 AND A<25`
> hard-fails. It has been replaced by the **demerit-scoring** scheme in
> [srad.md](srad.md). This file is retained only for historical reference and to explain
> changes scored under the old formula. **Do not use it for current behavior.**
