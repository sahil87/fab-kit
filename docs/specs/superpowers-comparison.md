...
| **Multi-agent coordination** | Operator system (operator5/6/7) with dependency-aware spawning, tmux pane routing, autopilot queues, proactive monitoring | Simpler model — fresh subagent per task, parallel dispatch for independent tasks, two-stage review |
