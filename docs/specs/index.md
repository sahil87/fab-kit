...
>
> **Ownership**: Specification content is written and maintained by humans. Navigation
> indexes are generated by `fab docs-index docs/specs`; organize topics to suit the project.
...
| File | Description |
|------|-------------|
| [The Assembly Line](assembly-line.md) | — |
