...
│  │    pane needs session_command + tmux, native needs native:true,
│  │    headless needs dispatch_command. Presence says HOW, never
...
│  │    no session_command, then native unavailable. Landing on
