...
│   the resolved model=/effort=/spawn= (visibility — 260613-m3d4, spawn= added
│   260702-aetz), then BRANCHES on spawn= (260702-aetz): absent ⇒ native dispatch
...
│   spawn= command; _preamble.md § CLI-Adapter Dispatch) — 260613-l3ja established
