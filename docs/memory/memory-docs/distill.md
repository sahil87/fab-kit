...
- **`index.md` (root/domain/sub-domain tiers) and `log.md` are the generated pair** — written solely by `fab docs-index docs/memory` (FKF §5/§6). The skill regenerates them after applying rewrites; it never edits their rows.
