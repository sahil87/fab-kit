...
| [pipeline-orchestrator](pipeline-orchestrator.md) | Pipeline orchestrator — YAML manifest format, serial dispatch loop, worktree isolation, Claude CLI execution, stacked PRs, SIGINT handling | 2026-02-21 |
