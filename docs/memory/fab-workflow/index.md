...
| [execution-skills](execution-skills.md) | Apply, review, hydrate, archive, operator, and orchestrator behavior — `/fab-continue` for pipeline stages, `/fab-archive` for housekeeping, `/fab-proceed` for context-aware pipeline orchestration, `/fab-operator7` for multi-agent coordination with dependency-aware spawning | 2026-03-31 |
...
| [distribution](distribution.md) | How `fab/.kit/` is distributed — Homebrew formula, system shim, `fab init` bootstrap, `fab upgrade`, release workflow | 2026-04-02 |
| [kit-architecture](kit-architecture.md) | `.kit/` structure (binary-free), system shim, scripts, agent integration, versioning, monorepos, underscore file ecosystem | 2026-04-02 |
