...
| [migrations](migrations.md) | Migration system — dual-version model, migration file format, `/fab-setup migrations` subcommand, brew-install migration, `1.8.0-to-1.9.0` migration (tasks-stage collapse + plan.md), version drift detection, `fab/.kit-migration-version` creation | 2026-05-06 |
