...
| [distribution](distribution.md) | How `src/kit/` is distributed — Homebrew formula (4 binaries), `fab` router, `fab-kit` lifecycle, `fab init` bootstrap, `fab upgrade`, release workflow (5 binaries, 20 cross-compiled) | 2026-04-02 |
