...
Ship and review-pr are the local delta: they resolve their roles, then delegate full `/git-pr` and `/git-pr-review` behaviors through the native model/effort seams; those skills manage their own transitions.
