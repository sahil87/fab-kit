...
One-shot `/fab-new` invocation executing **Phase 4 (policy + extraction)** of `fab/plans/sahil/skill-prose-consolidation.md`. Phases 1–3 are already merged to main (`260808-ip4q` drift fixes, `260808-mcxv` mechanical deletion, `260808-s2sz` structure restructures). The invocation specified:
