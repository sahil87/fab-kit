...
- **260312-9r3t-pr-change-metadata** — Add change identity metadata (ID, name, Linear issue links) to PR descriptions generated by /git-pr, improving traceability between GitHub PRs, fab changes, and Linear issues.
- **260312-96nf-remove-rust-implementation** — Remove the unmaintained Rust backend (src/rust/), its build commands, and dispatcher references to eliminate agent confusion and dead code.
