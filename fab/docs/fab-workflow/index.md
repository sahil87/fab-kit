...
| [planning-skills](planning-skills.md) | `/fab-new`, `/fab-discuss`, `/fab-continue`, `/fab-ff`, `/fab-clarify` — the planning pipeline from proposal through tasks, shared `_generation.md` partial | 2026-02-10 |
